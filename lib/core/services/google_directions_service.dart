...
///
/// This is a low-frequency call (one per fare estimate). Live ETAs are NOT
/// computed here — the backend calculates the traffic-aware ETA server-side and
/// pushes it over the WebSocket (see the live-ride flow), so the client makes
/// zero routing calls while a ride is in progress.
